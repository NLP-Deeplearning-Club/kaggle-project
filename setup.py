...
extensions = [
    Extension("speech_recognizer.libspeech_recognizer",
          sources = ["speech_recognizer/libspeech_recognizer.pyx"],
...
setup(
    ...
    entry_points={'console_scripts': ['speech_recognizer = speech_recognizer.main:main']},
    zip_safe=ZIP_SAFE,
